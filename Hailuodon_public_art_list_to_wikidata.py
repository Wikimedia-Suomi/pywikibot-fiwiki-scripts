...
SOURCE_PAGE_TITLE = 'Luettelo Hailuodon julkisista taideteoksista ja muistomerkeistä'
IMPORT_URL = None
...
def create_wikidata_item(entry):
    ...
    item.editLabels(labels, summary='Add artwork entry from Lieto list')
    ...
    item.editDescriptions(
        {'fi': f"{art_type} Hailuodossa, Suomi",
         'en': f"{art_type_en} in Hailuoto, Finland",
         'sv': f"{art_type_sv} i Karlö, Finland"},
    ...
    # P131 Located in → Raisio   Q372075    Lieto Q1017108   Hailuoto Q1569280
    add_claim_with_sources('P131', pywikibot.ItemPage(repo, 'Q1569280'), 'Add located in')
    ...
    # P5008 Focus list
    list_page = pywikibot.Page(site, "Wikiprojekti:Suomen_julkiset_taideteokset_ja_muistomerkit_Wikipediaan")
